...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            name='customer',
            options={'ordering': ('id',), 'verbose_name': 'Клиент', 'verbose_name_plural': 'Клиент'},
        ),
        ...
        migrations.AlterField(
            model_name='customer',
            name='phone',
            field=models.CharField(help_text='Телефон', max_length=11, unique=True, verbose_name='Телефон'),
        ),
    ]
